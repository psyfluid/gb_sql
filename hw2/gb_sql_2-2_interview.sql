...
# Поскольку в качестве user_id в таблицу posts записано значение 7, вероятно, это id клиента из таблицы clients, а не id пользователя
ALTER TABLE posts
